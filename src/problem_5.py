...
if args.q1:
    ...
    R_VALS, R_BAR, R_UCL, R_LCL = r_chart_values(DATA, sample_size, 'Voltage')
    
    # Calculate X-bar chart values
    X_BAR_VALS, X_BAR_BAR, X_BAR_UCL, X_BAR_LCL = x_bar_r_chart_values(DATA, sample_size, R_BAR, 'Voltage')
